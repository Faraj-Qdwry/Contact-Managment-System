...
public class RelativesVisibilityBehaviour implements ContactsVisibilityBehaviour {
    @Override
    public void setVisibility() {
        MUI mui = MUI.getInstance();

        mui.jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(null, mui.operation + " Relatives Details", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("DialogInput", 1, 16)));
